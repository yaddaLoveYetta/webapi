...
public class ApiContainer {
	...
	public void loadApiFromSpringbeans() {
		...
		// Map<String, Object> beansWithAnnotation = applicationContext.getBeansWithAnnotation(APIMapping.class);
		Class<?> type;
	 ...
	 * 
	 * @Title addApiItem
	 * @param classApiMapping
	 *            类上 api配置
	 * @param methodApiMapping
	 *            方法上api配置
	 * @param classApiVersion
	 *            类上 api版本配置
	 * @param methodApiVersion
	 *            方法上api版本配置
	 * @param beanName
	 *            bean在spring中的名称
	 * @param method
